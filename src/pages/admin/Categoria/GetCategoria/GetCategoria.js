...
function GetCategoria(idCateg) {
    ...
    useEffect(() => {
        const getcateg = async () => {
            const res = await fetch(
                `https://gemeos-server.herokuapp.com/categorias/${idCateg}`
            );
    ...
    const atualizarNomeCategoria = (e) => {
        e.preventDefault();
        Axios.patch(
            "https://gemeos-server.herokuapp.com/categorias/updateName",
            {
    ...
    const atualizarEmDestaqueCategoria = (e) => {
        e.preventDefault();
        Axios.patch(
            "https://gemeos-server.herokuapp.com/categorias/updateEmDestaque",
            {
    ...
    const atualizarStatusCategoria = (e) => {
        e.preventDefault();
        Axios.patch(
            "https://gemeos-server.herokuapp.com/categorias/updateStatus",
            {
                status: newStatus,
                id_categoria: parseInt(idCateg),
            },
