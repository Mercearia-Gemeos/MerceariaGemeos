...
function GetBanner(idBanner) {
    ...
    useEffect(() => {
        const getBanner = async () => {
            const res = await fetch(
                `http://localhost:4000/Banners/${idBanner}`
            );
    ...
    const atualizarImgBanner = (e) => {
        e.preventDefault();
        Axios.patch("http://localhost:4000/banners/updateImg", {
    ...
    const atualizarNomeBanner = (e) => {
        e.preventDefault();
        Axios.patch("http://localhost:4000/banners/updateNome", {
            nome: newNomeBanner,
            id_banner: parseInt(idBanner),
        },{
            headers: { 'Authorization':  `Bearer ${auth.accessToken}` }
    ...
    const atualizarDescBanner = (e) => {
        e.preventDefault();
        Axios.patch("http://localhost:4000/banners/updateDesc", {
    ...
    const atualizarStatusBanner = (e) => {
        e.preventDefault();
        Axios.patch("http://localhost:4000/banners/updateStatus", {
            status: newStatus,
            id_banner: parseInt(idBanner),
        },{
            headers: { 'Authorization':  `Bearer ${auth.accessToken}` }
